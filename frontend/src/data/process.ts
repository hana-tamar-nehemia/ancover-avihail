...
export const processSteps: ProcessStep[] = [
  {
    ...
    description:
      'ספרו לנו על סוג הפרויקט, המיקום ותאריך ההתחלה. נגיע עם scope ראשוני — לא סרט מדידה ריק. ללא התחייבות.',
  ...
  },
  {
    ...
    description:
      'הצוות שלנו בודק כל משטח, מתעד מצב ומכין מפת הגנה מלאה. תראו בדיוק מה יכוסה ואיך — בכתב.',
