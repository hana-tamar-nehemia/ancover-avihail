export const riskSection = {
  ...
  body: 'Ancover מתמחה בפתרונות הגנה זמנית לפרויקטי בנייה ושיפוץ - יזמי נדל"ן · פרויקטים מגורים · פרויקטים מסחריים. צוות פנימי, התקנה מקצועית ופתרון מותאם לכל פרויקט.',
